...
from reconstructed_minicode.tui.input_parser import KeyEvent, ParsedInputEvent, TextEvent, WheelEvent, parse_input_chunk
from reconstructed_minicode.tui.state import ScreenState, TtyAppArgs, AggregatedEditProgress
from reconstructed_minicode.cli.commands import try_handle_local_command, find_matching_slash_commands
from reconstructed_minicode.cli.shortcuts import parse_local_tool_shortcut
from reconstructed_minicode.tui.navigation import _scroll_pending_approval_by, _toggle_pending_approval_expand, _move_pending_approval_selection, _scroll_transcript_by, _jump_transcript_to_edge, _history_up, _history_down, _get_visible_commands
from reconstructed_minicode.tui.chrome import _cached_terminal_size
from reconstructed_minicode.tui.tool_helpers import _summarize_tool_input, _is_file_edit_tool, _extract_path_from_tool_input, _summarize_collapsed_tool_body
from reconstructed_minicode.tui.tool_lifecycle import _push_transcript_entry, _update_tool_entry, _update_transcript_entry, _append_to_transcript_entry, _collapse_tool_entry, _finalize_dangling_running_tools, _get_running_tool_entries, _schedule_tool_auto_collapse
from reconstructed_minicode.tools.base import ToolContext
from reconstructed_minicode.session.history import save_history_entries
...
class _RawModeContext:
    ...
    def __enter__(self) -> _RawModeContext:
        if sys.platform == "win32":
            ...
            from reconstructed_minicode.tui.screen import _enable_windows_vt_processing
...
def _handle_input(
    ...
    # Hook: user input
    from reconstructed_minicode.extensions.hooks import HookEvent, fire_hook_sync
    ...
    # Update app state
    if state.app_state:
        from reconstructed_minicode.agent.state import set_busy
