...
from reconstructed_minicode.cli.commands import SLASH_COMMANDS, find_matching_slash_commands
from reconstructed_minicode.tui.chrome import _cached_terminal_size
from reconstructed_minicode.tui.state import ScreenState, TtyAppArgs
from reconstructed_minicode.tui.chrome import get_permission_prompt_max_scroll_offset
from reconstructed_minicode.tui.transcript import get_transcript_max_scroll_offset


_HEADER_LINES_ESTIMATE = 7   # banner panel: 4 frame + 2 content + 1 wrap margin
_PROMPT_LINES_ESTIMATE = 7   # prompt panel: 4 frame + hint bar (2) + input (1)
_FOOTER_LINES = 1
_GAPS = 0                    # panels use \n (not \n\n), borders provide visual separation
_TRANSCRIPT_FRAME_LINES = 4  # session feed panel: top border + title + divider + bottom
