...
import time
import pytest
from reconstructed_minicode.extensions.memory import MemoryManager, MemoryScope


@pytest.mark.benchmark
def test_search_performance_100_entries(memory_manager):
    """Test search performance with 100 entries."""
    from reconstructed_minicode.test.test_helpers import create_memory_entries
...
def test_chinese_search_performance(memory_manager):
    ...
    from reconstructed_minicode.test.test_helpers import create_chinese_memory_entries
