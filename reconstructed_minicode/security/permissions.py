...
from reconstructed_minicode.config import MINI_CODE_PERMISSIONS_PATH

# Auto mode integration
from reconstructed_minicode.security.risk import AutoModeChecker, PermissionMode, RiskLevel, get_checker, get_mode_state
...
class PermissionManager:
    ...
    # 持久化和初始化权限数据 — 从磁盘加载允许/拒绝列表，并在修改后保存
