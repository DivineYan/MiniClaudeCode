...
from reconstructed_minicode.types import AgentStep
...
def create_model_adapter(
    ...
    if force_mock or os.environ.get("MINI_CODE_MODEL_MODE") == "mock":
        from reconstructed_minicode.model.mock import MockModelAdapter
    ...
    if provider_config.is_openai_compatible:
        from reconstructed_minicode.model.openai import OpenAIModelAdapter
    ...
    # Anthropic
    from reconstructed_minicode.model.anthropic import AnthropicModelAdapter
